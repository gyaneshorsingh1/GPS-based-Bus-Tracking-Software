            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <li>
                        ...
                        >
                            <svg
                                :class="(selected === 'Dashboard') || (page === 'ecommerce') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
                        ...
                        <!-- Dropdown Menu Start -->
                        <div
                            class="transform translate overflow-hidden"
                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <li>
                        <a
                            ...
                            class="menu-item group"
                            :class="(selected === 'UIElements') || (page === 'buttons' || page === 'images') ? 'menu-item-active' : 'menu-item-inactive'"
                        >
                            <svg
                                :class="(selected === 'UIElements') || (page === 'buttons' || page === 'images') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
