        ...
        [
            ...
            'items' => [
                [
                    ...
                    // ],
                    'dropdown' => null, // no dropdown -> links straight to route
                ],
                [
                    'key'    => 'Profile',
                    'label'  => 'User Profile',
        ...
        [
            ...
            'items' => [
                [
                    'key'    => 'UIElements',
                    'label'  => 'UI Elements',
                    'active' => ['buttons', 'images'],
                    'icon'   => 'heroicon-o-cube',
                    'dropdown' => [
                        ['label' => 'Buttons', 'route' => 'buttons', 'page' => 'buttons'],
                        ['label' => 'Images',  'route' => 'images',  'page' => 'images'],
                    ],
                ],

                // ---> To add a new item, just append another array here. <---
                // [
                //     'key' => 'Settings',
                //     'label' => 'Settings',
                //     'route' => 'settings',
