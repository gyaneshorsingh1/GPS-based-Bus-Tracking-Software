...
<script>
    ...
    function initBusMarker(startLatLng) {
        ...
        busMarker.bindPopup('<b>School Bus #{{ $bus->bus_number }}</b><br>Speed: 32 km/h • Live Route');
    }
    ...
    function startBusTrackingLoop() {
        ...
        // Synchronize telemetry card & timeline
        updateTelemetryCard(window.liveBusGps);
    ...
    function updateTelemetryCard(gps) {
        const speedEl = document.getElementById('liveBusSpeed');
        if (speedEl) speedEl.innerText = gps.speed;
